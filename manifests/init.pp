...
class rabbitmq (
  ...
  Variant[String,Sensitive[String]] $default_pass                                                  = 'guest',
  ...
  Optional[Variant[String,Sensitive[String]] $erlang_cookie                                        = undef,
  ...
  Optional[Variant[String,Sensitive[String]] $ssl_cert_password                                    = undef,
