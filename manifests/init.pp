...
class rabbitmq (
  ...
  Variant[String,Sensitive] $default_pass                                                  = 'guest',
  ...
  Optional[Variant[String,Sensitive]] $erlang_cookie                                       = undef,
  ...
  Optional[Variant[String,Sensitive]] $ssl_cert_password                                   = undef,
